...
public class IndexServlet extends BaseServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            } else if ("list".equals(action)) {//列表
                list(request, response);
            } else if ("detail".equals(action)) {//单条明细
    ...
    public void common(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        request.setAttribute("models", models);
        request.setAttribute("date", DateUtils.dateFormatToString("yyyy/MM/dd HH:mm:ss.SSSa"));
    }
}
